...
public class CreateOrderClientMockTest {
    ...
    public void setUp() throws Exception {
        ...
        product1.setId("2");
        product1.setName("superman action figure1");
        
        ProductType product2 = factory.createProductType();
        product1.setId("3");
        product1.setName("superman action figure2");
        
        ProductType product3 = factory.createProductType();
        product1.setId("4");
        product1.setName("superman action figure3");
    ...
    public void testCreateOrder() {
        Source requestPayload = new StringSource(
                "<ns2:order xmlns:ns2=\"http://iqmsoft.com/types/order\">"
                        ...
                        + "<ns2:product>" + "<ns2:id>4</ns2:id>"
                        + "<ns2:name>superman action figure3</ns2:name>"
                        + "</ns2:product>"
